...
#define CY_FX_EP_CONSUMER2				(0x85)	/* EP 5 IN  */

#define CY_FX_PRODUCER_USB_SOCKET    CY_U3P_UIB_SOCKET_PROD_2    /* USB Socket 2 is command request producer */
#define CY_FX_CONSUMER_USB_SOCKET    CY_U3P_UIB_SOCKET_CONS_1    /* USB Socket 1 is command status consumer */
#define CY_FX_CONSUMER2_USB_SOCKET   CY_U3P_UIB_SOCKET_CONS_5    /* USB Socket 5 is data consumer */
